...
/**
 * Wrapper for library <b>avfilter-6</b><br>
...
public class Avfilter6Library {
	...
	public static abstract class avfilter_execute_func extends Callback<avfilter_execute_func > {
		public int apply(Pointer<AVFilterContext > ctx, Pointer<avfilter_action_func > func, Pointer<? > arg, Pointer<Integer > ret, int nb_jobs) {
		...
		public int apply(@Ptr long ctx, @Ptr long func, @Ptr long arg, @Ptr long ret, int nb_jobs) {
			return apply((Pointer)Pointer.pointerToAddress(ctx, AVFilterContext.class), (Pointer)Pointer.pointerToAddress(func, avfilter_action_func.class), Pointer.pointerToAddress(arg), (Pointer)Pointer.pointerToAddress(ret, Integer.class), nb_jobs);
		}
	};
	/**
	...
	public static Pointer<AVBufferRef > av_buffersink_get_hw_frames_ctx(Pointer<AVFilterContext > ctx) {
		return (Pointer)Pointer.pointerToAddress(av_buffersink_get_hw_frames_ctx(Pointer.getPeer(ctx)), AVBufferRef.class);
	}
	@Ptr 
	...
	public static Pointer<AVBufferSrcParameters > av_buffersrc_parameters_alloc() {
		return (Pointer)Pointer.pointerToAddress(av_buffersrc_parameters_alloc$2(), AVBufferSrcParameters.class);
	}
	@Ptr 
	...
	public int dummy() {
		try {
			return (int)BridJ.getNativeLibrary("avfilter-6").getSymbolPointer("dummy").getInt();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public Avfilter6Library dummy(int dummy) {
		try {
			{
				BridJ.getNativeLibrary("avfilter-6").getSymbolPointer("dummy").setInt(dummy);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);

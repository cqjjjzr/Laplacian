...
import org.ffmpeg.avformat.AVFormatLibrary.AVBPrint;
import org.ffmpeg.avformat.AVFormatLibrary.FILE;

import java.util.Collections;
import java.util.Iterator;
/**
 * Wrapper for library <b>avutil-55</b><br>
...
public class AVUtilLibrary {
	 ...
	 * @{<br>
	 * enum values<br>
	 * <i>native declaration : libavutil\avutil.h:68</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\pixfmt.h:396</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\pixfmt.h:427</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\pixfmt.h:468</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\pixfmt.h:506</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\pixfmt.h:533</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\opt.h:184</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : libavutil\spherical.h:5</i>
	 */
	 ...
	 * @{<br>
	 * enum values<br>
	 * <i>native declaration : .\libavutil\channel_layout.h:14</i>
	 */
	...
	public static abstract class av_log_set_callback_callback_callback extends Callback<av_log_set_callback_callback_callback > {
		public void apply(Pointer<? > voidPtr1, int int1, Pointer<Byte > charPtr1, Pointer va_list1) {
			apply(Pointer.getPeer(voidPtr1), int1, Pointer.getPeer(charPtr1), va_list1);
		}
		public void apply(@Ptr long voidPtr1, int int1, @Ptr long charPtr1, Pointer va_list1) {
	...
	public static abstract class av_buffer_pool_init2_alloc_callback extends Callback<av_buffer_pool_init2_alloc_callback > {
		public Pointer<AVBufferRef > apply(Pointer<? > opaque, int size) {
			return (Pointer)Pointer.pointerToAddress(apply(Pointer.getPeer(opaque), size), AVBufferRef.class);
		}
		@Ptr 
	 ...
	 */
	public static byte av_get_picture_type_char(IntValuedEnum<AVPictureType > pict_type) {
	 ...
	 */
	public static native long av_clip64_c(long a, long amin, long amax);
	/**
	 ...
	 */
	public static native int av_clipl_int32_c(long a);
	/**
	 ...
	 */
	public static native int av_clip_intp2_c(int a, int p);
	/**
	 ...
	 */
	public static native int av_clip_uintp2_c(int a, int p);
	/**
	 ...
	 */
	public static native int av_mod_uintp2_c(int a, int p);
	/**
	 ...
	 */
	public static native int av_sat_add32_c(int a, int b);
	/**
	 ...
	 */
	public static native int av_sat_dadd32_c(int a, int b);
	/**
	 ...
	 */
	public static native float av_clipf_c(float a, float amin, float amax);
	/**
	 ...
	 */
	public static native double av_clipd_c(double a, double amin, double amax);
	/**
	 ...
	 */
	public static native int av_ceil_log2_c(int x);
	/**
	 ...
	 */
	public static native int av_popcount_c(int x);
	/**
	 * Count number of bits set to one in x<br>
	 * @param x value to count bits of<br>
	 * @return the number of bits set to one in x<br>
	 ...
	 */
	public static Pointer<Byte > av_make_error_string(Pointer<Byte > errbuf, @Ptr long errbuf_size, int errnum) {
		return (Pointer)Pointer.pointerToAddress(av_make_error_string(Pointer.getPeer(errbuf), errbuf_size, errnum), Byte.class);
	}
	@Ptr 
	protected native static long av_make_error_string(@Ptr long errbuf, @Ptr long errbuf_size, int errnum);
	/**
	 ...
	 */
	public static int av_size_mult(@Ptr long a, @Ptr long b, Pointer<SizeT > r) {
		return av_size_mult(a, b, Pointer.getPeer(r));
	}
	protected native static int av_size_mult(@Ptr long a, @Ptr long b, @Ptr long r);
	/**
	 ...
	 */
	public static native AVRational av_inv_q(AVRational q);
	/**
	 ...
	 */
	public static native float av_int2float(int i);
	/**
	 ...
	 */
	public static native double av_int2double(long i);
	/**
	 ...
	 */
	public static native long av_double2int(double f);
	/**
	 ...
	 */
	public static long av_rescale_rnd(long a, long b, long c, IntValuedEnum<AVRounding > rnd) {
	 ...
	 */
	public static long av_rescale_q_rnd(long a, AVRational bq, AVRational cq, IntValuedEnum<AVRounding > rnd) {
	 ...
	 */
	public static void av_log_set_callback(Pointer<av_log_set_callback_callback_callback > callback) {
	 ...
	 */
	public static IntValuedEnum<AVClassCategory > av_default_get_category(Pointer<? > ptr) {
		return FlagSet.fromValue(av_default_get_category(Pointer.getPeer(ptr)), AVClassCategory.class);
	}
	 ...
	 */
	public static void av_log_format_line(Pointer<? > ptr, int level, Pointer<Byte > fmt, Pointer<? > vl, Pointer<Byte > line, int line_size, Pointer<Integer > print_prefix) {
	...
	protected native static void av_log_format_line(@Ptr long ptr, int level, @Ptr long fmt, @Ptr long vl, @Ptr long line, int line_size, @Ptr long print_prefix);
	/**
	 * Format a line of log the same way as the default callback.<br>
	 * @param line          buffer to receive the formatted line;<br>
	 ...
	 */
	public static int av_log_format_line2(Pointer<? > ptr, int level, Pointer<Byte > fmt, Pointer<? > vl, Pointer<Byte > line, int line_size, Pointer<Integer > print_prefix) {
		return av_log_format_line2(Pointer.getPeer(ptr), level, Pointer.getPeer(fmt), Pointer.getPeer(vl), Pointer.getPeer(line), line_size, Pointer.getPeer(print_prefix));
	}
	protected native static int av_log_format_line2(@Ptr long ptr, int level, @Ptr long fmt, @Ptr long vl, @Ptr long line, int line_size, @Ptr long print_prefix);
	/**
	 ...
	 */
	public static Pointer<? > av_x_if_null(Pointer<? > p, Pointer<? > x) {
		return Pointer.pointerToAddress(av_x_if_null(Pointer.getPeer(p), Pointer.getPeer(x)));
	}
	@Ptr 
	protected native static long av_x_if_null(@Ptr long p, @Ptr long x);
	/**
	 ...
	 */
	public static Pointer<FILE > av_fopen_utf8(Pointer<Byte > path, Pointer<Byte > mode) {
		return (Pointer)Pointer.pointerToAddress(av_fopen_utf8(Pointer.getPeer(path), Pointer.getPeer(mode)), FILE.class);
	}
	@Ptr 
	...
	public static Pointer<Byte > av_fourcc_make_string(Pointer<Byte > buf, int fourcc) {
		return (Pointer)Pointer.pointerToAddress(av_fourcc_make_string(Pointer.getPeer(buf), fourcc), Byte.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<AVBufferRef > av_buffer_create(Pointer<Byte > data, int size, Pointer<av_buffer_create_free_callback > free, Pointer<? > opaque, int flags) {
	 ...
	 */
	public static Pointer<AVBufferPool > av_buffer_pool_init(int size, Pointer<av_buffer_pool_init_alloc_callback > alloc) {
		return (Pointer)Pointer.pointerToAddress(av_buffer_pool_init(size, Pointer.getPeer(alloc)), AVBufferPool.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<AVBufferPool > av_buffer_pool_init2(int size, Pointer<? > opaque, Pointer<av_buffer_pool_init2_alloc_callback > alloc, Pointer<av_buffer_pool_init2_pool_free_callback > pool_free) {
		return (Pointer)Pointer.pointerToAddress(av_buffer_pool_init2(size, Pointer.getPeer(opaque), Pointer.getPeer(alloc), Pointer.getPeer(pool_free)), AVBufferPool.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<Byte > av_get_sample_fmt_name(IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static IntValuedEnum<AVSampleFormat > av_get_sample_fmt(Pointer<Byte > name) {
		return FlagSet.fromValue(av_get_sample_fmt(Pointer.getPeer(name)), AVSampleFormat.class);
	}
	 ...
	 */
	public static IntValuedEnum<AVSampleFormat > av_get_alt_sample_fmt(IntValuedEnum<AVSampleFormat > sample_fmt, int planar) {
		return FlagSet.fromValue(av_get_alt_sample_fmt((int)sample_fmt.value(), planar), AVSampleFormat.class);
	}
	 ...
	 */
	public static IntValuedEnum<AVSampleFormat > av_get_packed_sample_fmt(IntValuedEnum<AVSampleFormat > sample_fmt) {
		return FlagSet.fromValue(av_get_packed_sample_fmt((int)sample_fmt.value()), AVSampleFormat.class);
	}
	 ...
	 */
	public static IntValuedEnum<AVSampleFormat > av_get_planar_sample_fmt(IntValuedEnum<AVSampleFormat > sample_fmt) {
		return FlagSet.fromValue(av_get_planar_sample_fmt((int)sample_fmt.value()), AVSampleFormat.class);
	}
	 ...
	 */
	public static Pointer<Byte > av_get_sample_fmt_string(Pointer<Byte > buf, int buf_size, IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static int av_get_bytes_per_sample(IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static int av_sample_fmt_is_planar(IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static int av_samples_get_buffer_size(Pointer<Integer > linesize, int nb_channels, int nb_samples, IntValuedEnum<AVSampleFormat > sample_fmt, int align) {
	 ...
	 */
	public static int av_samples_fill_arrays(Pointer<Pointer<Byte > > audio_data, Pointer<Integer > linesize, Pointer<Byte > buf, int nb_channels, int nb_samples, IntValuedEnum<AVSampleFormat > sample_fmt, int align) {
	 ...
	 */
	public static int av_samples_alloc(Pointer<Pointer<Byte > > audio_data, Pointer<Integer > linesize, int nb_channels, int nb_samples, IntValuedEnum<AVSampleFormat > sample_fmt, int align) {
	 ...
	 */
	public static int av_samples_alloc_array_and_samples(Pointer<Pointer<Pointer<Byte > > > audio_data, Pointer<Integer > linesize, int nb_channels, int nb_samples, IntValuedEnum<AVSampleFormat > sample_fmt, int align) {
	 ...
	 */
	public static int av_samples_copy(Pointer<Pointer<Byte > > dst, Pointer<Pointer<Byte > > src, int dst_offset, int src_offset, int nb_samples, int nb_channels, IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static int av_samples_set_silence(Pointer<Pointer<Byte > > audio_data, int offset, int nb_samples, int nb_channels, IntValuedEnum<AVSampleFormat > sample_fmt) {
	 ...
	 */
	public static IntValuedEnum<AVColorSpace > av_frame_get_colorspace(Pointer<AVFrame > frame) {
		return FlagSet.fromValue(av_frame_get_colorspace(Pointer.getPeer(frame)), AVColorSpace.class);
	}
	 ...
	 */
	public static void av_frame_set_colorspace(Pointer<AVFrame > frame, IntValuedEnum<AVColorSpace > val) {
	 ...
	 */
	public static IntValuedEnum<AVColorRange > av_frame_get_color_range(Pointer<AVFrame > frame) {
		return FlagSet.fromValue(av_frame_get_color_range(Pointer.getPeer(frame)), AVColorRange.class);
	}
	 ...
	 */
	public static void av_frame_set_color_range(Pointer<AVFrame > frame, IntValuedEnum<AVColorRange > val) {
	 ...
	 */
	public static Pointer<Byte > av_get_colorspace_name(IntValuedEnum<AVColorSpace > val) {
	 ...
	 */
	public static Pointer<AVFrameSideData > av_frame_new_side_data(Pointer<AVFrame > frame, IntValuedEnum<AVFrameSideDataType > type, int size) {
	 ...
	 */
	public static Pointer<AVFrameSideData > av_frame_get_side_data(Pointer<AVFrame > frame, IntValuedEnum<AVFrameSideDataType > type) {
	 ...
	 */
	public static void av_frame_remove_side_data(Pointer<AVFrame > frame, IntValuedEnum<AVFrameSideDataType > type) {
	 ...
	 */
	public static Pointer<Byte > av_frame_side_data_name(IntValuedEnum<AVFrameSideDataType > type) {
	 ...
	 */
	public static int av_opt_set_pixel_fmt(Pointer<? > obj, Pointer<Byte > name, IntValuedEnum<AVPixelFormat > fmt, int search_flags) {
	 ...
	 */
	public static int av_opt_set_sample_fmt(Pointer<? > obj, Pointer<Byte > name, IntValuedEnum<AVSampleFormat > fmt, int search_flags) {
	 ...
	 */
	public static int av_opt_get_pixel_fmt(Pointer<? > obj, Pointer<Byte > name, int search_flags, Pointer<IntValuedEnum<AVPixelFormat > > out_fmt) {
	 ...
	 */
	public static int av_opt_get_sample_fmt(Pointer<? > obj, Pointer<Byte > name, int search_flags, Pointer<IntValuedEnum<AVSampleFormat > > out_fmt) {
	 ...
	 */
	public static Pointer<AVPixFmtDescriptor > av_pix_fmt_desc_get(IntValuedEnum<AVPixelFormat > pix_fmt) {
	 ...
	 */
	public static IntValuedEnum<AVPixelFormat > av_pix_fmt_desc_get_id(Pointer<AVPixFmtDescriptor > desc) {
		return FlagSet.fromValue(av_pix_fmt_desc_get_id(Pointer.getPeer(desc)), AVPixelFormat.class);
	}
	 ...
	 */
	public static int av_pix_fmt_get_chroma_sub_sample(IntValuedEnum<AVPixelFormat > pix_fmt, Pointer<Integer > h_shift, Pointer<Integer > v_shift) {
	 ...
	 */
	public static int av_pix_fmt_count_planes(IntValuedEnum<AVPixelFormat > pix_fmt) {
	 ...
	 */
	public static Pointer<Byte > av_color_range_name(IntValuedEnum<AVColorRange > range) {
	 ...
	 */
	public static Pointer<Byte > av_color_primaries_name(IntValuedEnum<AVColorPrimaries > primaries) {
	 ...
	 */
	public static Pointer<Byte > av_color_transfer_name(IntValuedEnum<AVColorTransferCharacteristic > transfer) {
	 ...
	 */
	public static Pointer<Byte > av_color_space_name(IntValuedEnum<AVColorSpace > space) {
	 ...
	 */
	public static Pointer<Byte > av_chroma_location_name(IntValuedEnum<AVChromaLocation > location) {
	 ...
	 */
	public static IntValuedEnum<AVPixelFormat > av_get_pix_fmt(Pointer<Byte > name) {
		return FlagSet.fromValue(av_get_pix_fmt(Pointer.getPeer(name)), AVPixelFormat.class);
	}
	 ...
	 */
	public static Pointer<Byte > av_get_pix_fmt_name(IntValuedEnum<AVPixelFormat > pix_fmt) {
	 ...
	 */
	public static Pointer<Byte > av_get_pix_fmt_string(Pointer<Byte > buf, int buf_size, IntValuedEnum<AVPixelFormat > pix_fmt) {
	 ...
	 */
	public static IntValuedEnum<AVPixelFormat > av_pix_fmt_swap_endianness(IntValuedEnum<AVPixelFormat > pix_fmt) {
		return FlagSet.fromValue(av_pix_fmt_swap_endianness((int)pix_fmt.value()), AVPixelFormat.class);
	}
	 ...
	 */
	public static int av_get_pix_fmt_loss(IntValuedEnum<AVPixelFormat > dst_pix_fmt, IntValuedEnum<AVPixelFormat > src_pix_fmt, int has_alpha) {
	 ...
	 */
	public static IntValuedEnum<AVPixelFormat > av_find_best_pix_fmt_of_2(IntValuedEnum<AVPixelFormat > dst_pix_fmt1, IntValuedEnum<AVPixelFormat > dst_pix_fmt2, IntValuedEnum<AVPixelFormat > src_pix_fmt, int has_alpha, Pointer<Integer > loss_ptr) {
		return FlagSet.fromValue(av_find_best_pix_fmt_of_2((int)dst_pix_fmt1.value(), (int)dst_pix_fmt2.value(), (int)src_pix_fmt.value(), has_alpha, Pointer.getPeer(loss_ptr)), AVPixelFormat.class);
	}
	 ...
	 */
	public static int av_image_get_linesize(IntValuedEnum<AVPixelFormat > pix_fmt, int width, int plane) {
	 ...
	 */
	public static int av_image_fill_linesizes(Pointer<Integer > linesizes, IntValuedEnum<AVPixelFormat > pix_fmt, int width) {
	 ...
	 */
	public static int av_image_fill_pointers(Pointer<Pointer<Byte > > data, IntValuedEnum<AVPixelFormat > pix_fmt, int height, Pointer<Byte > ptr, Pointer<Integer > linesizes) {
	 ...
	 */
	public static void av_image_copy(Pointer<Pointer<Byte > > dst_data, Pointer<Integer > dst_linesizes, Pointer<Pointer<Byte > > src_data, Pointer<Integer > src_linesizes, IntValuedEnum<AVPixelFormat > pix_fmt, int width, int height) {
	 ...
	 */
	public static void av_image_copy_uc_from(Pointer<Pointer<Byte > > dst_data, Pointer<SizeT > dst_linesizes, Pointer<Pointer<Byte > > src_data, Pointer<SizeT > src_linesizes, IntValuedEnum<AVPixelFormat > pix_fmt, int width, int height) {
	 ...
	 */
	public static int av_image_fill_arrays(Pointer<Pointer<Byte > > dst_data, Pointer<Integer > dst_linesize, Pointer<Byte > src, IntValuedEnum<AVPixelFormat > pix_fmt, int width, int height, int align) {
	 ...
	 */
	public static int av_image_get_buffer_size(IntValuedEnum<AVPixelFormat > pix_fmt, int width, int height, int align) {
	 ...
	 */
	public static int av_image_copy_to_buffer(Pointer<Byte > dst, int dst_size, Pointer<Pointer<Byte > > src_data, Pointer<Integer > src_linesize, IntValuedEnum<AVPixelFormat > pix_fmt, int width, int height, int align) {
	 ...
	 */
	public static int av_image_check_size2(int w, int h, long max_pixels, IntValuedEnum<AVPixelFormat > pix_fmt, int log_offset, Pointer<? > log_ctx) {
	...
	public static Pointer<AVSphericalMapping > av_spherical_alloc(Pointer<SizeT > size) {
		return (Pointer)Pointer.pointerToAddress(av_spherical_alloc(Pointer.getPeer(size)), AVSphericalMapping.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<Byte > av_spherical_projection_name(IntValuedEnum<AVSphericalProjection > projection) {
		return (Pointer)Pointer.pointerToAddress(av_spherical_projection_name((int)projection.value()), Byte.class);
	}
	@Ptr 

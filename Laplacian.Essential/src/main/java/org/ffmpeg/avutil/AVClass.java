...
/**
 * <i>native declaration : libavutil\log.h:44</i><br>
...
public class AVClass extends StructObject {
	...
	@Field(1) 
	public Pointer<item_name_callback > item_name() {
		return this.io.getPointerField(this, 1);
	}
	/** C type : item_name_callback* */
	@Field(1) 
	public AVClass item_name(Pointer<item_name_callback > item_name) {
	...
	@Field(6) 
	public Pointer<child_next_callback > child_next() {
		return this.io.getPointerField(this, 6);
	}
	/** C type : child_next_callback* */
	@Field(6) 
	public AVClass child_next(Pointer<child_next_callback > child_next) {
		this.io.setPointerField(this, 6, child_next);
		return this;
	}
	/** C type : child_class_next_callback* */
	@Field(7) 
	public Pointer<child_class_next_callback > child_class_next() {
		return this.io.getPointerField(this, 7);
	}
	/** C type : child_class_next_callback* */
	@Field(7) 
	public AVClass child_class_next(Pointer<child_class_next_callback > child_class_next) {
	...
	@Field(9) 
	public Pointer<get_category_callback > get_category() {
		return this.io.getPointerField(this, 9);
	}
	/** C type : get_category_callback* */
	@Field(9) 
	public AVClass get_category(Pointer<get_category_callback > get_category) {
		this.io.setPointerField(this, 9, get_category);
		return this;
	}
	/** C type : query_ranges_callback* */
	@Field(10) 
	public Pointer<query_ranges_callback > query_ranges() {
		return this.io.getPointerField(this, 10);
	}
	/** C type : query_ranges_callback* */
	@Field(10) 
	public AVClass query_ranges(Pointer<query_ranges_callback > query_ranges) {
		this.io.setPointerField(this, 10, query_ranges);
		return this;
	}
	/** <i>native declaration : libavutil\log.h:39</i> */
	public static abstract class item_name_callback extends Callback<item_name_callback > {
		public Pointer<Byte > apply(Pointer<? > ctx) {
			return (Pointer)Pointer.pointerToAddress(apply(Pointer.getPeer(ctx)), Byte.class);
		}
		@Ptr 
	...
	/** <i>native declaration : libavutil\log.h:40</i> */
	...
	/** <i>native declaration : libavutil\log.h:41</i> */
	public static abstract class child_class_next_callback extends Callback<child_class_next_callback > {
		public Pointer<AVClass > apply(Pointer<AVClass > prev) {
			return (Pointer)Pointer.pointerToAddress(apply(Pointer.getPeer(prev)), AVClass.class);
		}
		@Ptr 
		public long apply(@Ptr long prev) {
			return Pointer.getPeer(apply((Pointer)Pointer.pointerToAddress(prev, AVClass.class)));
		}
	};
	/** <i>native declaration : libavutil\log.h:42</i> */
	...
	/** <i>native declaration : libavutil\log.h:43</i> */
	public static abstract class query_ranges_callback extends Callback<query_ranges_callback > {
		...
		public int apply(@Ptr long AVOptionRangesPtrPtr1, @Ptr long obj, @Ptr long key, int flags) {
			return apply((Pointer)Pointer.pointerToAddress(AVOptionRangesPtrPtr1, DefaultParameterizedType.paramType(Pointer.class, AVOptionRanges.class)), Pointer.pointerToAddress(obj), (Pointer)Pointer.pointerToAddress(key, Byte.class), flags);
		}
	};
	public AVClass() {
		super();

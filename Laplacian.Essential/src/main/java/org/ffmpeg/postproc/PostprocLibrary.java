...
/**
 * Wrapper for library <b>postproc-54</b><br>
...
public class PostprocLibrary {
	...
	/** <i>native declaration : .\libpostproc\version.h</i> */
	public static final String LIBPOSTPROC_IDENT = (String)"postproc.5.100";
	/** <i>native declaration : .\libpostproc\version.h</i> */
	...
	public static Pointer<Byte > postproc_configuration() {
		return (Pointer)Pointer.pointerToAddress(postproc_configuration$2(), Byte.class);
	}
	@Ptr 
	@Name("postproc_configuration") 
	...
	public static Pointer<Byte > postproc_license() {
		return (Pointer)Pointer.pointerToAddress(postproc_license$2(), Byte.class);
	}
	@Ptr 
	@Name("postproc_license") 
	...
	public Pointer<Byte > pp_help() {
		try {
			return (Pointer<Byte >)BridJ.getNativeLibrary("postproc-54").getSymbolPointer("pp_help").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).get();
		}catch (Throwable $ex$) {
	...
	public PostprocLibrary pp_help(Pointer<Byte > pp_help) {
		try {
			{
				BridJ.getNativeLibrary("postproc-54").getSymbolPointer("pp_help").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).set(pp_help);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);

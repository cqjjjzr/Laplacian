...
public class SwResampleLibrary {
	...
	public static Pointer<AVClass > swr_get_class() {
		return (Pointer)Pointer.pointerToAddress(swr_get_class$2(), AVClass.class);
	}
	@Ptr 
	@Name("swr_get_class") 
	...
	public static Pointer<SwrContext > swr_alloc() {
		return (Pointer)Pointer.pointerToAddress(swr_alloc$2(), SwrContext.class);
	}
	@Ptr 
	@Name("swr_alloc") 
	...
	public static Pointer<SwrContext > swr_alloc_set_opts(Pointer<SwrContext > s, long out_ch_layout, IntValuedEnum<AVSampleFormat > out_sample_fmt, int out_sample_rate, long in_ch_layout, IntValuedEnum<AVSampleFormat > in_sample_fmt, int in_sample_rate, int log_offset, Pointer<? > log_ctx) {
		return (Pointer)Pointer.pointerToAddress(swr_alloc_set_opts(Pointer.getPeer(s), out_ch_layout, (int)out_sample_fmt.value(), out_sample_rate, in_ch_layout, (int)in_sample_fmt.value(), in_sample_rate, log_offset, Pointer.getPeer(log_ctx)), SwrContext.class);
	}
	@Ptr 
	...
	public static Pointer<Byte > swresample_configuration() {
		return (Pointer)Pointer.pointerToAddress(swresample_configuration$2(), Byte.class);
	}
	@Ptr 
	...
	public static Pointer<Byte > swresample_license() {
		return (Pointer)Pointer.pointerToAddress(swresample_license$2(), Byte.class);
	}
	@Ptr 

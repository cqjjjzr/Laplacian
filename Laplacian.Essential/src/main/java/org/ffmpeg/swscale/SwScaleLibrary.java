...
/**
 * Wrapper for library <b>swscale-4</b><br>
...
public class SwScaleLibrary {
	...
	public static Pointer<Byte > swscale_configuration() {
		return (Pointer)Pointer.pointerToAddress(swscale_configuration$2(), Byte.class);
	}
	@Ptr 
	...
	public static Pointer<Byte > swscale_license() {
		return (Pointer)Pointer.pointerToAddress(swscale_license$2(), Byte.class);
	}
	@Ptr 
	...
	public static Pointer<Integer > sws_getCoefficients(int colorspace) {
		return (Pointer)Pointer.pointerToAddress(sws_getCoefficients$2(colorspace), Integer.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<SwsContext > sws_alloc_context() {
		return (Pointer)Pointer.pointerToAddress(sws_alloc_context$2(), SwsContext.class);
	}
	@Ptr 
	 ...
	 */
	public static int sws_init_context(Pointer<SwsContext > sws_context, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter) {
	 ...
	 */
	public static void sws_freeContext(Pointer<SwsContext > swsContext) {
	 ...
	 */
	public static Pointer<SwsContext > sws_getContext(int srcW, int srcH, IntValuedEnum<AVPixelFormat > srcFormat, int dstW, int dstH, IntValuedEnum<AVPixelFormat > dstFormat, int flags, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter, Pointer<Double > param) {
		return (Pointer)Pointer.pointerToAddress(sws_getContext(srcW, srcH, (int)srcFormat.value(), dstW, dstH, (int)dstFormat.value(), flags, Pointer.getPeer(srcFilter), Pointer.getPeer(dstFilter), Pointer.getPeer(param)), SwsContext.class);
	}
	@Ptr 
	 ...
	 */
	public static int sws_setColorspaceDetails(Pointer<SwsContext > c, Pointer<Integer > inv_table, int srcRange, Pointer<Integer > table, int dstRange, int brightness, int contrast, int saturation) {
	 ...
	 */
	public static int sws_getColorspaceDetails(Pointer<SwsContext > c, Pointer<Pointer<Integer > > inv_table, Pointer<Integer > srcRange, Pointer<Pointer<Integer > > table, Pointer<Integer > dstRange, Pointer<Integer > brightness, Pointer<Integer > contrast, Pointer<Integer > saturation) {
	...
	public static Pointer<SwsVector > sws_allocVec(int length) {
		return (Pointer)Pointer.pointerToAddress(sws_allocVec$2(length), SwsVector.class);
	}
	@Ptr 
	@Name("sws_allocVec") 
	...
	public static Pointer<SwsVector > sws_getGaussianVec(double variance, double quality) {
		return (Pointer)Pointer.pointerToAddress(sws_getGaussianVec$2(variance, quality), SwsVector.class);
	}
	@Ptr 
	...
	public static Pointer<SwsVector > sws_getConstVec(double c, int length) {
		return (Pointer)Pointer.pointerToAddress(sws_getConstVec$2(c, length), SwsVector.class);
	}
	@Ptr 
	@Name("sws_getConstVec") 
	...
	public static Pointer<SwsVector > sws_getIdentityVec() {
		return (Pointer)Pointer.pointerToAddress(sws_getIdentityVec$2(), SwsVector.class);
	}
	@Ptr 
	@Name("sws_getIdentityVec") 
	...
	public static Pointer<SwsVector > sws_cloneVec(Pointer<SwsVector > a) {
		return (Pointer)Pointer.pointerToAddress(sws_cloneVec(Pointer.getPeer(a)), SwsVector.class);
	}
	@Ptr 
	...
	public static Pointer<SwsFilter > sws_getDefaultFilter(float lumaGBlur, float chromaGBlur, float lumaSharpen, float chromaSharpen, float chromaHShift, float chromaVShift, int verbose) {
		return (Pointer)Pointer.pointerToAddress(sws_getDefaultFilter$2(lumaGBlur, chromaGBlur, lumaSharpen, chromaSharpen, chromaHShift, chromaVShift, verbose), SwsFilter.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<SwsContext > sws_getCachedContext(Pointer<SwsContext > context, int srcW, int srcH, IntValuedEnum<AVPixelFormat > srcFormat, int dstW, int dstH, IntValuedEnum<AVPixelFormat > dstFormat, int flags, Pointer<SwsFilter > srcFilter, Pointer<SwsFilter > dstFilter, Pointer<Double > param) {
		return (Pointer)Pointer.pointerToAddress(sws_getCachedContext(Pointer.getPeer(context), srcW, srcH, (int)srcFormat.value(), dstW, dstH, (int)dstFormat.value(), flags, Pointer.getPeer(srcFilter), Pointer.getPeer(dstFilter), Pointer.getPeer(param)), SwsContext.class);
	}
	@Ptr 
	...
	public static Pointer<AVClass > sws_get_class() {
		return (Pointer)Pointer.pointerToAddress(sws_get_class$2(), AVClass.class);
	}
	@Ptr 
	@Name("sws_get_class") 

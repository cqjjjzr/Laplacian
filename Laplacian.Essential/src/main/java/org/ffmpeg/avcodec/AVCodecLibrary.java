...
/**
 * Wrapper for library <b>avcodec-57</b><br>
...
public class AVCodecLibrary {
	 ...
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:462</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:504</i>
	 */
	 ...
	 * @{<br>
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:594</i>
	 */
	 ...
	 * after decoding.<br>
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:649</i>
	 */
	...
	/**
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:665</i>
	 */
	 ...
	 * @}<br>
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:1089</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration : .\libavcodec\avcodec.h:2692</i>
	 */
	...
	/** <i>native declaration : .\libavcodec\version.h</i> */
	public static final boolean FF_API_VIMA_DECODER = (boolean) true;
	/** <i>native declaration : .\libavcodec\version.h</i> */
	public static final boolean FF_API_AUDIO_CONVERT = (boolean) true;
	/** <i>native declaration : .\libavcodec\version.h</i> */
	...
	public static Pointer<AVCodecParameters > avcodec_parameters_alloc() {
		return (Pointer)Pointer.pointerToAddress(avcodec_parameters_alloc$2(), AVCodecParameters.class);
	}
	@Ptr 
	...
	public static Pointer<AVPacket > av_packet_alloc() {
		return (Pointer)Pointer.pointerToAddress(av_packet_alloc$2(), AVPacket.class);
	}
	@Ptr 
	...
	public static Pointer<AVPacket > av_packet_clone(Pointer<AVPacket > src) {
		return (Pointer)Pointer.pointerToAddress(av_packet_clone(Pointer.getPeer(src)), AVPacket.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<Byte > av_packet_new_side_data(Pointer<AVPacket > pkt, IntValuedEnum<AVPacketSideDataType > type, int size) {
	 ...
	 */
	public static int av_packet_add_side_data(Pointer<AVPacket > pkt, IntValuedEnum<AVPacketSideDataType > type, Pointer<Byte > data, @Ptr long size) {
	 ...
	 */
	public static int av_packet_shrink_side_data(Pointer<AVPacket > pkt, IntValuedEnum<AVPacketSideDataType > type, int size) {
	 ...
	 */
	public static Pointer<Byte > av_packet_get_side_data(Pointer<AVPacket > pkt, IntValuedEnum<AVPacketSideDataType > type, Pointer<Integer > size) {
	 ...
	 */
	public static Pointer<Byte > av_packet_side_data_name(IntValuedEnum<AVPacketSideDataType > type) {
	 ...
	 */
	public static Pointer<AVCodec > avcodec_find_decoder(IntValuedEnum<AVCodecID > id) {
	 ...
	 */
	public static Pointer<AVCodec > avcodec_find_encoder(IntValuedEnum<AVCodecID > id) {
	...
	public static Pointer<ReSampleContext > av_audio_resample_init(int output_channels, int input_channels, int output_rate, int input_rate, IntValuedEnum<AVSampleFormat > sample_fmt_out, IntValuedEnum<AVSampleFormat > sample_fmt_in, int filter_length, int log2_phase_count, int linear, double cutoff) {
		return (Pointer)Pointer.pointerToAddress(av_audio_resample_init(output_channels, input_channels, output_rate, input_rate, (int)sample_fmt_out.value(), (int)sample_fmt_in.value(), filter_length, log2_phase_count, linear, cutoff), ReSampleContext.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<AVResampleContext > av_resample_init(int out_rate, int in_rate, int filter_length, int log2_phase_count, int linear, double cutoff) {
		return (Pointer)Pointer.pointerToAddress(av_resample_init$2(out_rate, in_rate, filter_length, log2_phase_count, linear, cutoff), AVResampleContext.class);
	}
	@Ptr 
	 ...
	 */
	public static int av_resample(Pointer<AVResampleContext > c, Pointer<Short > dst, Pointer<Short > src, Pointer<Integer > consumed, int src_size, int dst_size, int update_ctx) {
	 ...
	 */
	public static void av_resample_compensate(Pointer<AVResampleContext > c, int sample_delta, int compensation_distance) {
	 ...
	 */
	public static void av_resample_close(Pointer<AVResampleContext > c) {
	 ...
	 */
	public static Pointer<Byte > avcodec_profile_name(IntValuedEnum<AVCodecID > codec_id, int profile) {
		return (Pointer)Pointer.pointerToAddress(avcodec_profile_name((int)codec_id.value(), profile), Byte.class);
	}
	@Ptr 
	 ...
	 */
	public static int avcodec_default_execute(Pointer<AVCodecContext > c, Pointer<avcodec_default_execute_func_callback > func, Pointer<? > arg, Pointer<Integer > ret, int count, int size) {
	 ...
	 */
	public static int avcodec_default_execute2(Pointer<AVCodecContext > c, Pointer<avcodec_default_execute2_func_callback > func, Pointer<? > arg, Pointer<Integer > ret, int count) {
	 ...
	 */
	public static int av_get_bits_per_sample(IntValuedEnum<AVCodecID > codec_id) {
	 ...
	 */
	public static IntValuedEnum<AVCodecID > av_get_pcm_codec(IntValuedEnum<AVSampleFormat > fmt, int be) {
		return FlagSet.fromValue(av_get_pcm_codec((int)fmt.value(), be), AVCodecID.class);
	}
	 ...
	 */
	public static int av_get_exact_bits_per_sample(IntValuedEnum<AVCodecID > codec_id) {
	...
	public static Pointer<AVBitStreamFilter > av_bsf_get_by_name(Pointer<Byte > name) {
		return (Pointer)Pointer.pointerToAddress(av_bsf_get_by_name(Pointer.getPeer(name)), AVBitStreamFilter.class);
	}
	@Ptr 
	...
	public static Pointer<AVBitStreamFilter > av_bsf_next(Pointer<Pointer<? > > opaque) {
		return (Pointer)Pointer.pointerToAddress(av_bsf_next(Pointer.getPeer(opaque)), AVBitStreamFilter.class);
	}
	@Ptr 
	...
	public static Pointer<AVClass > av_bsf_get_class() {
		return (Pointer)Pointer.pointerToAddress(av_bsf_get_class$2(), AVClass.class);
	}
	@Ptr 
	 ...
	 */
	public static Pointer<AVBSFList > av_bsf_list_alloc() {
		return (Pointer)Pointer.pointerToAddress(av_bsf_list_alloc$2(), AVBSFList.class);
	}
	@Ptr 
	 ...
	 */
	public static IntValuedEnum<AVMediaType > avcodec_get_type(IntValuedEnum<AVCodecID > codec_id) {
	 ...
	 */
	public static Pointer<Byte > avcodec_get_name(IntValuedEnum<AVCodecID > id) {
	 ...
	 */
	public static Pointer<AVCodecDescriptor > avcodec_descriptor_get(IntValuedEnum<AVCodecID > id) {
	...
	public static Pointer<AVCPBProperties > av_cpb_properties_alloc(Pointer<SizeT > size) {
		return (Pointer)Pointer.pointerToAddress(av_cpb_properties_alloc(Pointer.getPeer(size)), AVCPBProperties.class);
	}
	@Ptr 

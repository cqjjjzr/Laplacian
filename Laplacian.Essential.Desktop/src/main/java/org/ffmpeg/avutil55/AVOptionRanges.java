...
public class AVOptionRanges extends Structure {
	...
	public org.ffmpeg.avutil55.AVOptionRange.ByReference[] range;
	...
	protected List<String> getFieldOrder() {
		return Arrays.asList("range", "nb_ranges", "nb_components");
	}
	/** @param range C type : AVOptionRange** */
	public AVOptionRanges(org.ffmpeg.avutil55.AVOptionRange.ByReference range[], int nb_ranges, int nb_components) {
		super();

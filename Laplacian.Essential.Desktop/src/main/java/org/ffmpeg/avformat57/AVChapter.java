...
/**
 * <i>native declaration : libavformat\avformat.h:324</i><br>
...
public class AVChapter extends Structure {
	 ...
	 */
	public AVChapter(int id, AVRational time_base, long start, long end, org.ffmpeg.avutil55.AVDictionary.ByReference metadata) {
		super();
		this.id = id;
